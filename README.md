...
1. Download the APK file of the app from the [releases](https://github.com/fitareq/AssessmentAppHPL/blob/master/app/release/app-release.apk) section on GitHub.
